...
function ContextRail({ domain, open, savedViews, activeItem, onItem, onView, onSaveView, onNavigate, onClose, notify, panelRef }) {
  if (!open) return null;
...
export function App() {
  ...
  return <div className={`admin-shell ${contextOpen ? "context-open" : "context-closed"}`} data-testid="admin-shell">
    ...
    <ContextRail domain={domain} open={contextOpen} savedViews={savedViews} activeItem={contextItem} onItem={selectContextItem} onView={applyView} onSaveView={() => openDialog("save-view")} onNavigate={navigate} onClose={closeContext} notify={notify} panelRef={contextPanelRef} />
