/**
 * NovaStore - Müþteri Bildirim Sistemi (notifications.js)
 * SADECE müþteri sayfalarý için (index.html). Admin panelinin kendi sistemi var.
 * Týklanýnca › profile.html#orders veya ilgili sekme açýlýr.
 */
...
const NOTIF_META = {
    order_update: { emoji: '??', title: 'Sipariþ Güncellendi', color: '#3b82f6', page: 'profile.html', tab: 'orders' },
    new_order: { emoji: '??', title: 'Yeni Sipariþ', color: '#F7941D', page: null, tab: null },
    new_review: { emoji: '?', title: 'Yeni Yorum', color: '#a855f7', page: 'profile.html', tab: 'reviews' },
    low_stock: { emoji: '??', title: 'Düþük Stok', color: '#ef4444', page: null, tab: null },
    welcome: { emoji: '??', title: 'Hoþ Geldiniz', color: '#22c55e', page: null, tab: null },
    question_answered: { emoji: '??', title: 'Soru Cevaplandý', color: '#2E7D32', page: 'profile.html', tab: 'questions' },
};

// ¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
//  BAÞLATICI — Sadece giriþ yapmýþ MÜÞTERÝ için çalýþýr
//  (Admin sayfasý deðilse ve kullanýcý token varsa)
// ¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
function initNotifications() {
    // Bu sayfa admin paneli deðilse ve kullanýcý giriþ yapmýþsa çalýþtýr
    const isAdminPage = window.location.pathname.includes('admin.html');
    if (isAdminPage) return; // Admin panelinin kendi sistemi var

    const userInfoStr = localStorage.getItem('nova_user_info');
    if (!userInfoStr) return; // Giriþ yapýlmamýþ
    ...
    // Dropdown dýþýna týklanýnca kapat
...
function _requestNotifPermission() {
    ...
    if (Notification.permission === 'denied') return;    // Zaten reddedildi, rahatsýz etme

    // Eðer kullanýcý daha önce banner'ý kapattýysa bir daha gösterme
    if (localStorage.getItem('nova_notif_banner_dismissed')) return;

    // 'default' durumundayýz — banner'ý göster
    _showPermissionBanner();
}

// Bildirim izni bannerý — "Bildirimleri Aç" düðmesi
function _showPermissionBanner() {
    ...
    banner.innerHTML = `
        <span>?? Sipariþleriniz hakkýnda bildirim almak ister misiniz?</span>
        <button id="btn-enable-notif" style="background:#F7941D; border:none; color:white; padding:8px 16px; border-radius:8px; cursor:pointer; font-weight:700; white-space:nowrap;">› Evet, Ýzin Ver</button>
        <button id="btn-dismiss-notif" style="background:rgba(255,255,255,0.15); border:none; color:white; padding:6px 12px; border-radius:8px; cursor:pointer;">Hayýr</button>
    `;
    ...
    document.getElementById('btn-enable-notif').onclick = () => {
        Notification.requestPermission().then(perm => {
            ...
            if (perm === 'granted') {
                alert('? Bildirimler aktif! Artýk sipariþleriniz hakkýnda anlýk bildirim alacaksýnýz.');
            } else {
...
// ¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
//  SOCKET.IO — Kullanýcý odasýný dinle
// ¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
function _connectSocket(room) {
    if (typeof io === 'undefined') return;
    try {
        _notifSocket = io(window.location.origin, { transports: ['websocket', 'polling'] });
...
// ¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
//  NAVÝGASYON — Týklanýnca nereye gidilecek
// ¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
...
function _navigateToNotif(type) {
    ...
    // Ayný sayfadaysak tab geç, farklý sayfadaysak yönlendir
...
function showToast(notifOrMsg, type = 'order_update') {
    ...
    // Toast'a týklanýnca ilgili sayfaya git
    if (notifObj) {
